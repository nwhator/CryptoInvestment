...
CREATE TABLE `generals` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `web_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'Investment Platform',
...
(1, 'Roi Standard', '200', '1500', NULL, '2.5', 10, 24, 1, '2020-05-29 14:11:52', '2020-06-05 21:49:19'),
(2, 'Fixed Standard', NULL, NULL, '1000', '7.5', NULL, 720, 0, '2020-05-29 14:12:17', '2020-06-05 22:15:04'),
(3, 'ROI Advanced', '1500', '3000', NULL, '7.5', 20, 168, 1, '2020-06-05 00:08:46', '2020-06-05 21:51:09'),
(4, 'ROI Premium', '4000', '9000', NULL, '15', 99, 720, 1, '2020-06-05 21:54:36', '2020-06-05 21:54:36'),
...
(2, '5edf6e8574dc7852.png', 'OPEN AN ACCOUNT', 'You can open investment accounts entirely online, with no need for signatures or branch ... you can invest with us online—even opening your account', '2020-05-15 14:00:18', '2020-06-09 15:12:05'),
(3, '5edf6ed6035bb901.png', 'GIVE INTEREST', 'Review and compare interest rates to find the best investment package for you, ... While it\'s true that most banks do not give high interest, but with us the case is different', '2020-05-15 14:00:30', '2020-06-09 15:13:26'),
(4, '5edf6d01b90ef567.png', 'GET DEPOSIT', 'Online Credit Card Deposit. You can make VISA, MC, or Discover card deposits, directly from your cryptowallets or paypal', '2020-05-15 14:28:53', '2020-06-09 15:09:33');
